...
>(
  (
    ...
    React.useEffect(() => {
      ...
      return () => window.removeEventListener("keydown", onChange)
    }, [toggleSidebar])
...
interface SidebarGroupLabelProps extends React.ComponentProps<"div"> { asChild?: boolean }
...
interface SidebarGroupActionProps extends React.ComponentProps<"button"> { asChild?: boolean, showOnHover?: boolean }

const SidebarGroupAction = ({ className, asChild = false, showOnHover = false, ...props }: SidebarGroupActionProps) => {
...
const SidebarMenuSubButton = ({ asChild = false, size = "md", isActive, className, ...props }: SidebarMenuSubButtonProps) => {
